      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">Cognitive</h1>
            <p className="mt-2 text-white/70">Energy, friction, recovery protocols.</p>
          </div>
        ...
        <div className="mt-8 rounded-3xl border border-white/15 bg-white/5 p-6 text-sm text-white/70">
          This sector helps users perform better:
          <ul className="mt-3 list-disc pl-6">
            <li>Identify “stuck” patterns</li>
            <li>Recovery routines</li>
            <li>Focus-friendly scheduling</li>
          </ul>
        </div>
      </div>
    </div>
