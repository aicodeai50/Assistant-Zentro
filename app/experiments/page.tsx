  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-6 py-12">
      <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
        <div>
          <div className="text-xs tracking-widest text-white/70">EXPLORE EXPERIMENTS (BETA)</div>
          <h1 className="mt-2 text-4xl font-semibold text-white">Standalone AI universes</h1>
          <p className="mt-3 max-w-2xl text-white/70">
            Experiments are immersive prototypes — separate from Shynvo OS. Each evolves independently with its own versions and visuals.
          </p>
        </div>
        ...
        <Link href="/experiments/beta-notes" className={CARD}>
          ...
          <div className="relative">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <div className="text-sm text-white/85 group-hover:text-white">Open notes →</div>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="mt-10 text-center text-xs text-white/45">
        Experiments are separate from Shynvo OS • Each destination evolves independently
      </div>
    </div>
  );
}
