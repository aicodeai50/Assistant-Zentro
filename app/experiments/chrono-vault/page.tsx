...
export default function ChronoVaultStubPage() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="pointer-events-none fixed inset-0">
        <div
          ...
          style={{
            background:
              "radial-gradient(1100px circle at 20% 20%, rgba(167,139,250,0.22), transparent 55%), radial-gradient(1100px circle at 80% 22%, rgba(56,189,248,0.14), transparent 60%), linear-gradient(180deg, rgba(2,6,23,0.70), rgba(0,0,0,0.92))",
          }}
        />
      ...
      <div className="relative mx-auto w-full max-w-3xl px-4 py-12">
        <div className="rounded-3xl border border-white/15 bg-black/40 p-6 backdrop-blur-xl">
          <div className="text-2xl font-semibold">Chrono Vault</div>
          <div className="mt-2 text-sm text-white/70">
            Coming next: future-self simulator with branching timeline and “what-if” sliders.
          </div>
