...
export default async function ConceptForgePage({
  searchParams,
}: {
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-12">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">Concept Forge</h1>
            <p className="mt-2 text-white/70">
              Build clarity with relationships: dependencies, cause-effect, and concept maps.
            </p>
          </div>
        ...
        <div className="mt-8">
          <ArenaTutor faculty={faculty} arena="concept-forge" />
        </div>
      </div>
    </div>
  );
