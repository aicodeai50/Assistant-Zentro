...
export default function Page() {
  return (
    <EnterpriseDetailPage
      ...
      focusItems={[
        { title: "Controlled Flow", desc: "Support enterprise execution with more disciplined workflow structure." },
      ...
      actionItems={[
        { title: "Review sensitive workflow areas", desc: "Check what should be more protected or governed." },
