...
export default function Page() {
  return (
    <EnterpriseDetailPage
      ...
      focusItems={[
        { title: "Role Rules", desc: "Define which roles can view, manage, or control enterprise features." },
      ...
      actionItems={[
        { title: "Review access gaps", desc: "Check for roles with too much or too little workspace access." },
