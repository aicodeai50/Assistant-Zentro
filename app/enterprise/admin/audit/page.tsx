...
export default function Page() {
  return (
    <EnterpriseDetailPage
      ...
      focusItems={[
        { title: "Activity Logs", desc: "Review key workspace actions and changes across enterprise modules." },
      ...
      actionItems={[
        { title: "Review recent admin actions", desc: "Check latest changes in permissions, users, and controls." },
