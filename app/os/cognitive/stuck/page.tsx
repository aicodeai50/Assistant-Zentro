...
const STUCK_TYPES: Array<{ key: StuckType; icon: string; hint: string }> = [
  { key: "Too big", icon: "Ì≥¶", hint: "Task is massive and shapeless." },
  { key: "Too vague", icon: "Ìº´Ô∏è", hint: "No clear next move." },
  { key: "Too risky", icon: "‚ö†Ô∏è", hint: "Fear of wasting time or failing." },
  { key: "No energy", icon: "Ì¥ã", hint: "Capacity is low." },
  { key: "No clarity", icon: "Ì∑©", hint: "Missing info / direction." },
];
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <OSCard title="Scope" value={type === "Too big" ? "Reduce 80%" : "Small slice"} hint="protocol" icon="‚úÇÔ∏è" />
            <OSCard title="Clarity" value={type === "No clarity" ? "Ask 1 question" : "Good enough"} hint="protocol" icon="Ì¥é" />
            <OSCard title="Momentum" value={type === "No energy" ? "Micro-session" : "Commit 1 step"} hint="protocol" icon="Ì∫Ä" />
          </div>
