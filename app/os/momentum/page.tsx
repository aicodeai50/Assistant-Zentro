      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">Momentum</h1>
            <p className="mt-2 text-white/70">Consistency engine: drills + reflection.</p>
          </div>
        ...
        <div className="mt-8 rounded-3xl border border-white/15 bg-white/5 p-6 text-sm text-white/70">
          ...
          <ul className="mt-3 list-disc pl-6">
            <li>Daily micro-drills</li>
            <li>Weekly review</li>
            <li>Skill progress streaks</li>
          </ul>
        </div>
      </div>
    </div>
