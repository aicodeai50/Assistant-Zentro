...
const LABS = [
  { href:"/frontier/coding",     title:"Coding Arena",          desc:"AI-assisted build workspace for products, websites, tools, and Python.", tags:["Build","AI","Projects"],  status:"Adaptive" },
  ...
  { href:"/frontier/puzzles",    title:"Logic Puzzles",         desc:"Train deduction with layered hints and guided reasoning progression.",    tags:["Puzzles","Hints","Practice"], status:"Training" },
];
...
export default function FrontierLabPage() {
  return (
    <section style={{maxWidth:960,margin:"0 auto",padding:"40px 20px 80px",position:"relative",zIndex:1}}>
        ...
        <div style={{display:"flex",flexWrap:"wrap",alignItems:"flex-start",justifyContent:"space-between",gap:16}}>
          <div style={{maxWidth:520}}>
            ...
            <p style={{...mono,fontSize:11,color:"rgba(255,255,255,0.48)",lineHeight:1.75,marginBottom:14}}>
              Build with code, solve technical problems, and explore structured system thinking. Engineering intelligence, active.
            </p>
            <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
              <Link href="/" style={{...mono,fontSize:9,color:"rgba(255,255,255,0.5)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:3,padding:"5px 10px",textDecoration:"none",letterSpacing:"0.06em",textTransform:"uppercase"}}>← Back</Link>
              <Link href="/docs" style={{...mono,fontSize:9,color:"rgba(255,255,255,0.5)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:3,padding:"5px 10px",textDecoration:"none",letterSpacing:"0.06em",textTransform:"uppercase"}}>Docs</Link>
            </div>
          </div>
      ...
      {/* Labs grid */}
      <div style={{marginTop:14,display:"grid",gap:10,gridTemplateColumns:"repeat(auto-fit,minmax(min(100%,220px),1fr))"}}>
        {LABS.map(lab=>(
          <Link key={lab.href} href={lab.href} className="env-card" style={{textDecoration:"none"}}>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
              ...
              <span style={{...mono,fontSize:8,color:C,border:`1px solid rgba(168,85,247,0.22)`,borderRadius:3,padding:"2px 6px",letterSpacing:"0.08em",textTransform:"uppercase"}}>{lab.status}</span>
            </div>
        ...
        {[
          ...
          <div key={s.l} className="env-panel" style={{"--env-color":C} as React.CSSProperties}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
              ...
              <span style={{...mono,fontSize:9,color:C,letterSpacing:"0.08em",textTransform:"uppercase"}}>{s.v}</span>
            </div>
      ...
      <div className="env-panel" style={{"--env-color":C,marginTop:14} as React.CSSProperties}>
        <div style={{display:"flex",flexWrap:"wrap",alignItems:"center",justifyContent:"space-between",gap:16}}>
          <div>
            ...
            <p style={{...mono,fontSize:11,color:"rgba(255,255,255,0.44)",maxWidth:380}}>Begin with Coding Arena, move into Algorithm Challenges, then explore AI Bot Lab for advanced system behavior.</p>
          </div>
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            ...
            <Link href="/frontier/algorithms" style={{...mono,fontSize:10,color:C,border:`1px solid rgba(168,85,247,0.28)`,padding:"9px 14px",borderRadius:3,textDecoration:"none",letterSpacing:"0.08em",textTransform:"uppercase"}}>Algorithm Challenges</Link>
          </div>
        </div>
      </div>
    </section>
